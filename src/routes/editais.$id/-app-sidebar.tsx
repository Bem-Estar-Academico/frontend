...
import type { FormQuestion } from "../_app/editais/$id/-data";
import type { FormValues } from "../_app/editais/$id/-schema";
import formData from "../_app/editais/$id/-data";
import { Separator } from "@/components/ui/separator";

export type StudentFormSidebarProps = {
  title: string;
  activeTab: string;
  form: any;
...
export function StudentFormSidebar({
  title, 
  form, 
  changeTab, 
  beneficiosSection,
...
const formValues = useWatch({ control: form.control });
  ...
  const hasQuestionError = React.useCallback((question: FormQuestion): boolean => {
