  ...
  if (!url) {
    return (
      <div className="flex flex-col h-full items-center justify-center text-gray-500 bg-gray-100 gap-[6px]">
        ...
        <div className="text-lg font-medium font-inter text-[18px] text-muted-foreground">Nenhum documento selecionado</div>
        <div className="text-base font-inter text-[14px] text-muted-foreground">
